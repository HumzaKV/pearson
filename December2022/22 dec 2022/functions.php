...
function codex_our_packages() {
	...
	<script>
		...
		jq(document).on("click", ".package-btn", function () {
			...
			jq('#ginput_base_price_3_20').val(PKGPr.text().'.00');
			jq('#input_2_8').val(PKGTitle.text());
			// var CForm_name = jq('#input_2_8').attr('type');
			// if (CForm_name == 'hidden')
			// 	console.log('test'+PKGTitle.text());
			// else
		...
		<?php foreach( $packages_content as $packages_content ) {
			...
			<div class="packages-container">
				...
				<div class="package-content">
					...
					<a class="package-btn <?php echo $popup_class; ?>" href="javascript:;" data-popup-open="<?php echo $popup_class; ?>"><?php echo $button_text; ?></a>
				</div>
			</div>
		<?php } ?>
	</div>
